  ...
  const [testimonials] = useState([
    {
      ...
      name: "Michael S.",
      rating: 5,
      comment: "The food here is absolutely incredible! Every dish is prepared with such care and attention to detail."
    },
    {
      id: 2,
      name: "Sarah J.",
      rating: 5,
      comment: "My family comes here every Friday night. It's become our favorite tradition!"
    },
    {
      id: 3,
      name: "David T.",
      rating: 4,
      comment: "Fast service, friendly staff, and always consistent quality. Highly recommended!"
    }
  ]);
            ...
            <div className="flex flex-col md:flex-row md:items-center md:space-x-8">
              <div className="md:w-1/2 mb-6 md:mb-0">
                ...
                <p className="mb-4 text-gray-600 leading-relaxed">
                  Our restaurant has been serving delicious, handcrafted meals to
                ...
                <p className="mb-6 text-gray-600 leading-relaxed">
                  Our chefs ensure every dish offers the perfect balance of flavors and textures. 
