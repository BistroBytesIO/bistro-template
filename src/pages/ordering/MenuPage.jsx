          ...
          <div className="relative mt-4">
            ...
            >
              <div
                ...
                data-category-id=""
                className={`flex-shrink-0 px-4 py-2 ml-6 mr-1 rounded-full cursor-pointer snap-start transition-colors ${selectedCategory === "" ? "bg-primary text-white" : "bg-white hover:bg-gray-100"
                  }`}
              >
                All Items
              </div>
              ...
              {categories.map((category) => (
                <div
                  ...
                  className={`flex-shrink-0 px-4 py-2 mx-1 rounded-full cursor-pointer snap-start transition-colors ${selectedCategory === category.id.toString() ? "bg-primary text-white" : "bg-white hover:bg-gray-100"
                    }`}
                >
                  {category.name}
                </div>
