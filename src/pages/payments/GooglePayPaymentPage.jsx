    ...
    useEffect(() => {
        ...
        const initializeGooglePay = async () => {
            try {
                ...
                // Check if payment request can be made (Google Pay availability)
            ...
            <div className="max-w-lg mx-auto">
                ...
                <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-xs text-blue-800 text-center">
                        <strong>Note:</strong> Google Pay requires a supported browser and device.
                        Make sure you're signed into your Google account and have payment methods saved.
                    </p>
                </div>
            </div>
        </div>
